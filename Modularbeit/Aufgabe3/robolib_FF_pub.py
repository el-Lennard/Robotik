...
qRoArm = np.array([3.14159265, -1.570796327, 0.0, 0.0, 3.14159265])
...
def inv_RoArm(dh_para, pose, qGripper):
    ...
    Q = np.array([[q1, q21, q31, q41, qGripper, 0], [q1, q22, q32, q42, qGripper, 0]])  
    return Q
...
q = pose_new
#q = pose
lösung = inv_RoArm(dhRoArm, q, np.pi)
print("GelenkWinkel:")
print(lösung[0]*(180/np.pi))
print(lösung[1]*(180/np.pi))
